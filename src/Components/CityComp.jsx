...
const places = [
    {
        ...
        category: "Restaurant",
        address: "456 Yummy Avenue, Abuja",
      ...
      },
      {
        "name": "Luxe Lounge",
        "category": "Lounge",
        "address": "789 Opulence Street, Lagos",
        ...
        "images": [
          "https://images.pexels.com/photos/323910/pexels-photo-323910.jpeg?auto=compress&cs=tinysrgb&w=800",
      ...
      },
      {
        "name": "Sunrise Suites",
        "category": "Hotel",
        "address": "101 Vacation Lane, Port Harcourt",
      ...
      },
    {
      ...
      category: "Spa",
      address: "567 Serenity Street, Enugu",
    ...
    }, 
    {
      ...
      category: "Beach",
      address: "321 Shoreline Road, Calabar",
    ...
    },
    {
      ...
      "https://images.pexels.com/photos/261204/pexels-photo-261204.jpeg?auto=compress&cs=tinysrgb&w=800",
    ],
    ...
    const [stateSpots, setStateSpots] = useState([]);


    //Function to extract the state from the full address
  ...
  return (
    ...
    <div className=' mt-20 '>
        <h2 className=' text-2xl text-center mx-6 mt-10 md:text-3xl font-semibold'>{state}</h2>
        <p className='mx-6 text-slate-400 text-center text-sm font-light mt-1 mb-6 sm:mb-14'>Check out amazing Spots in {state}!</p>
        <div className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-11 m-6 
        '>
           

{/* Change {navSpots} to the state {stateSpots} */}
{places.map((navSpot, index) => (
  state === getLastWord(navSpot.address) ? (

    // New Card Design
    <Link to={`/Spots`} key={index} onClick={() => setSelectedSpot(navSpot.name)}><Card src={navSpot.images[1]} alt={navSpot.name} title={navSpot.name} address={navSpot.address} feature={navSpot.category} /></Link>
