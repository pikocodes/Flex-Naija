...
function PageHero({spot, riderText, loginAccount}) {
  ...
  return (
   ...
   <div className='container'>
        ...
        <img src='https://images.pexels.com/photos/221457/pexels-photo-221457.jpeg?auto=compress&cs=tinysrgb&w=800' alt="Hero" className='image '/> 
       
    
      {/* Switch 'image' to 'CatergoryImage' */}
   </div>
